...
gapminder |>
  ...
  mutate(
    life_exp_improvement = lifeExp_2007 - lifeExp_1952
  ) |>
  ggplot(aes(x = reorder(continent, -life_exp_improvement), y = life_exp_improvement, fill = continent)) +
  geom_boxplot(show.legend = FALSE) +
  scale_fill_brewer(palette = "Dark2") +
  labs(
    title = "Life Expectancy Improvement 1952-2007",
    x = "Continent",
    y = "Life Expectancy Change (years)"
  ) +
  theme_minimal()
```