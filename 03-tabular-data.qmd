...
We can use `table()` to get a broad overview of what we are dealing with
...
Using the `gapminder` data, find out the following:

1. How many different countries are in the dataset?
2. For the country of _Mauritius_, what is the range of years we have data for?
3. Which country has the longest life expectancy in any year after 2000?
...
- Sometimes a function does exactly what it says it does, like `sort()`
