...
- `is.character()`, `is.numeric()`, `is.integer()` and `is.logical()` _check_ types
...
- `quantile(..., probs = ...)` for qantiles at probabilities given as `probs`
...
- `pbirthday(20, classes = 365, coincident = 2)` probability of two people sharing the samer birthday in a group of 20
